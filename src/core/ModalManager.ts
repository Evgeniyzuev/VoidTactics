...
export class ModalManager {
    ...
    showFAQDialog(onClose: () => void) {
        ...
        const sections = [
            ...
            ['Что защищает Terra?', 'Вокруг Terra находятся шесть обычных неподвижных военных флотов с Threat 10 000 и скоростью 0. Они используют общую систему сенсоров, AI и боя.'],
